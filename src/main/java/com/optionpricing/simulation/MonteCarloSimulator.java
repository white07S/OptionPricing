...
/**
 * MonteCarloSimulator performs Monte Carlo simulations to estimate the price of a given option.
 * It supports European, American, and Bermudan options and utilizes multi-threading to parallelize simulations.
 * Extends {@link Task} to allow integration with JavaFX for progress updates and cancellation.
 */
public class MonteCarloSimulator extends Task<Double> {
    private static final Logger LOGGER = Logger.getLogger(MonteCarloSimulator.class.getName());
    ...
    protected Double call() throws Exception {
        try {
            ...
            // Ensure that the executor service is properly shutdown
    ...
    private Double simulateEuropeanOption() throws InterruptedException, ExecutionException {
        ...
        // Atomic counter to track the number of completed simulations
